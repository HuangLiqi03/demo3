...
MP_SOLUTIONS = {
    ...
    "PickAndPlace_DEMO3": solvePickCube,
    "PlaceSphere_DEMO3": solvePlaceSphere,
    "StackCube_DEMO3": solveStackCube,
    "PegInsertionSide_DEMO3": solvePegInsertionSide,
    "LiftPegUpright_DEMO3": solveLiftPegUpright,
    "PokeCube_DEMO3": solvePushCube,
}
